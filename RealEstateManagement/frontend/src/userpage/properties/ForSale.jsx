  ...
  useEffect(() => {
    fetch('http://localhost:1111/property')
      ...
      .then(data => {
        ...
        const forSaleProperties = data.filter(property => {
          console.log('Property:', property, 'For Sale:', property.forsale);
          return property.forsale === true || property.forsale === "true";
        });
        console.log('Filtered Properties:', forSaleProperties);
    ...
    <div className="buy-container">
      ...
      {selectedProperty && (
        <div className="property-details">
          <button onClick={closeDetails} className="close-btn">X</button>
